...
const EdTechSlider1 = ({handleScrollTo}) => {
    return(
         <section className="font-helvetica tracking-[-0.03em] box-border grid grid-cols-1 md:grid-cols-2 text-[#F7F7F7] leading-[120%] bg-[#fff] md:min-h-[528px] lg:min-h-screen w-screen">
            {/* Grid 1 */}
             <div className="h-full relative">
                {/* layer-1 */}
                <div onClick={() => handleScrollTo(1)} className="cursor-pointer bg-[#3E2F5B] p-[24px] lg:p-[40px] h-full md:h-[60%] 2xl:min-h-[65%] relative">
                    {/* this arrow only shows on mobile */}
                        <div className="flex md:hidden flex-col justify-end align-bottom cursor-pointer absolute top-[24px] right-[24px]">
                            ...
                            <Image src="/Images/white-arrow.svg" fill alt="Dodo-digital-inclusion" />
                            </div>
                        </div>
                        {/* end of the mobile arrow */}
                    <div className="flex flex-col md:flex-row items-start justify-start gap-[16px] md:gap-[40px]">
                        <div>
                            <h5 className="font-helvetica-medium text-[80px] md:text-[70px] xl:text-[88px] 2xl:text-[110px] leading-[100%] tracking-[-3.54px]">73%</h5>
                            <div className="leading-[120%]">
                              ...
                              <p className="text-[20px] md:text-[14px] xl:text-[25px] 2xl:text-[28px] leading-[120%] tracking-[-0.03em]">Ghana (n=33)</p>
                            </div>
                        </div>
                    ...
                    <div className="mt-[24px]">
                        <h5 className="font-helvetica-medium text-[80px] md:text-[70px] xl:text-[88px] 2xl:text-[110px] leading-[100%] tracking-[-3.54px]">64%</h5>
                        <div className="leading-[120%]">
                            <span className="text-[14px] md:text-[10px] xl:text-[16px] 2xl:text-[19px] leading-[120%] tracking-[-0.03em]">Respondents in</span>
                            <p className="text-[20px] md:text-[14px] xl:text-[25px] 2xl:text-[28px] leading-[120%] tracking-[-0.03em]">Nigeria (n=50)</p>
                        </div>
                    </div>
                    ...
                    <div className="relative mt-[24px] md:absolute md:bottom-[32px] xl:bottom-[40px] md:right-[24px] xl:right-[40px] 2xl:right-[48px] block md:w-[358px] 2xl:w-[424px]">
                        <div className="w-full flex flex-row justify-between items-end text-[18px] xl:text-[18px] 2xl:text-[24px] leading-[125%]">
                        <p className="w-[264px] lg:w-[232px] 2xl:w-[338px] tracking-[-0.03em]">
                ...
                <div className="box-border hidden md:grid grid-cols-2 md:min-h-[40%] 2xl:min-h-[35%]">
                    <div className="p-[24px] xl:p-[40px] bg-[#D7253D]">
                        <p className="text-[28px]  tracking-[-0.03em] leading-[120%]">
                        ...
                        <div className="mt-[43px] xl:mt-[71px] 2xl:mt-[85px] border border-[#F2BA0F] border-x-0 border-b-0 pt-[10px] xl:pt-[16px]">
                         <p className="max-w-[121px] xl:max-w-[170px] leading-[120%] text-[8px] xl:text-[16px] 2xl:text-[20px] tracking-[-0.03em]">To truly scale access to education</p>
                        </div>
                    </div>
                        ...
                        <section className="flex items-center gap-[14px] xl:gap-[32px]">
                            ...
                            <div className="space-y-[12px]">
                                <div className="flex items-center leading-[100%]">
                                    <div className="text-[32px] xl:text-[56px] 2xl:text-[68px] leading-[100%] font-helvetica-medium">8</div>
                                    <span className="text-[8px] pt-[10px] 2xl:pt-[15px] xl:text-[14px] 2xl:text-[16px] max-w-[47px] 2xl:max-w-[55px] tracking-[-0.03em]">West African</span></div>
                                <p className="text-[12px] xl:text-[20px] 2xl:text-[24px] tracking-[-0.03em]">Countries</p>
                            </div>
                        </section>
                        <section className="tracking-[-0.03em] text-[12px] xl:text-[18px] 2xl:text-[22px] mt-[40px] xl:mt-[70px] 2xl:mt-[85px] max-w-[270px] 2xl:max-w-[321px] leading-[120%]">
             ...
             <section className="relative">
                {/* layer 1 */}
                <section onClick={() => handleScrollTo(2)} className="cursor-pointer md:min-h-[26%] p-[24px] md:p-[40px] bg-[#000F07] flex justify-between items-start relative">
                     <div className="flex flex-col md:flex-row items-start md:items-end justify-start gap-y-[16px] md:gap-x-[40px]">
                        <div >
                            <h5 className="font-helvetica-medium text-[80px] md:text-[70px] xl:text-[80px] 2xl:text-[96px] leading-[100%] tracking-[-3.54px]">45%</h5>
                            <div className="leading-[120%]">
                              <span className="text-[14px] md:text-[10px] xl:text-[16px] 2xl:text-[19px] leading-[120%] tracking-[-0.03em]">Respondents in</span>
                              <p className="text-[20px] md:text-[14px] xl:text-[25px] 2xl:text-[28px] leading-[120%] tracking-[-0.03em]">Ghana (n=33)</p>
                            </div>
                        ...
                        <div className="w-[200px] 2xl:w-[190px] text-[18px] 2xl:text-[18px] tracking-[-0.03em]">
             ...
             <div className="grid grid-cols-1 md:hidden">
                    <div className="p-[24px] md:p-[40px]  bg-[#D7253D]">
                        <p className="text-[28px] 2xl:text-[34px] leading-[120%] max-w-[300px] md:w-full tracking-[-0.03em]">
                         Edtech platforms must meet learners where they are
                        </p>

                        <div className="mt-[40px] md:mt-[71px] 2xl:mt-[85px] border border-[#F2BA0F] border-x-0 border-b-0 pt-[16px]">
                            <p className="max-w-[235px] 2xl:max-w-[170px] leading-[120%] text-[18px] 2xl:text-[20px] tracking-[-0.03em]">To truly scale access to education</p>
                        </div>
                    </div>

                    <div className="bg-[#126F63] px-[24px] md:px-[40px] py-[40px]">
                        ...
                        <section className="text-[18px] 2xl:text-[22px] mt-[40px] md:mt-[70px] tracking-[-0.03em] 2xl:mt-[85px] max-w-[236px] 2xl:max-w-[321px] leading-[120%]">
                            Revealing diverse experiences with digital learning and use of technology.
                        </section>
                    </div>
                </div>
